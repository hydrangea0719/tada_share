...
expName = 'untitled1'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/tadamizuki/Desktop/00授業/60認知科学演習1/牧岡先生/認知科学演習プログラム_本番用/untitled1_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('stim_info.xlsx'),
...
for thisTrial in trials:
    ...
    # update component parameters for each repeat
    image.setImage(stim_name)
    count_trial = count_trial + 1
    if count_trial % count_rest == 0:
        is_rest = 1
    else:
        is_rest = 0
    # keep track of which components have finished
    ...
    _key_resp_allKeys = []
    # keep track of which components have finished
    respComponents = [textbox, key_resp, text_2]
    ...
    # set up handler to look after randomisation of conditions etc
    trials_2 = data.TrialHandler(nReps=is_rest, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    for thisTrial_2 in trials_2:
        ...
        _key_resp_3_allKeys = []
        # keep track of which components have finished
        RestComponents = [rest_text, key_resp_3]
        ...
        for thisComponent in RestComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        trials_2.addData('rest_text.started', rest_text.tStartRefresh)
        trials_2.addData('rest_text.stopped', rest_text.tStopRefresh)
        # check responses
    ...
    # completed is_rest repeats of 'trials_2'
